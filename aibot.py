...
# New code - different from chatbot
# The right way is to store in a secret place, the right way for the app owner. 
# Create a secret in a non-public location.  
...
st.image("https://upload.wikimedia.org/wikipedia/commons/c/c8/Question_mark_1.svg", caption="question", width=50)                
